...
const projectId = ""; //projectId of dialogflow
const knowledgeBaseId = ""; //knowledgeBaseId of dialogflow
...
class MessageRouter {
    ...
    _sendConnectionStatusToOperator(customerId, disconnected) {
        ...
        // We're using Socket.io for our chat, which provides a synchronous API. However, in later case
        // can to swich it out for an async call, this method returns a promise.
    ...
    _sendUtteranceToOperator(utterance, customer, isAgentResponse) {
        ...
        // We're using Socket.io for our chat, which provides a synchronous API. However, in later case
        // we can swich it out for an async call, this method returns a promise.
        return Promise.resolve();
    }
